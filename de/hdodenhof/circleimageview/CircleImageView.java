...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mBorderColor = -16777216;
        this.mBorderWidth = 0;
        TypedArray a = context.obtainStyledAttributes(attrs, C0175R.styleable.CircleImageView, defStyle, 0);
        this.mBorderWidth = a.getDimensionPixelSize(C0175R.styleable.CircleImageView_border_width, 0);
        this.mBorderColor = a.getColor(C0175R.styleable.CircleImageView_border_color, -16777216);
        this.mBorderOverlay = a.getBoolean(C0175R.styleable.CircleImageView_border_overlay, false);
        a.recycle();
        init();
    }
