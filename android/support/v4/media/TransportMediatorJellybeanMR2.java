...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C00614();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C00603();
    ...
    final OnWindowAttachListener mWindowAttachListener = new C00581();
    final OnWindowFocusChangeListener mWindowFocusListener = new C00592();

    class C00581 implements OnWindowAttachListener {
        C00581() {
        }
    ...
    class C00592 implements OnWindowFocusChangeListener {
        C00592() {
        }
    ...
    class C00603 extends BroadcastReceiver {
        C00603() {
        }
    ...
    class C00614 implements OnAudioFocusChangeListener {
        C00614() {
        }
