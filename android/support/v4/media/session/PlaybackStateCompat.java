...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C00691();
    ...
    static class C00691 implements Creator<PlaybackStateCompat> {
        C00691() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C00701();
        ...
        static class C00701 implements Creator<CustomAction> {
            C00701() {
            }
