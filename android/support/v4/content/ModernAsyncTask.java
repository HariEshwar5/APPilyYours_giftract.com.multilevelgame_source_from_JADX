...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00491();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C02202();

    static class C00491 implements ThreadFactory {
    ...
    class C02202 extends WorkerRunnable<Params, Result> {
        C02202() {
            super();
        }
