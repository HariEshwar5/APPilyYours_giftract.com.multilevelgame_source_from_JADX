...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C00901();
    ...
    private static final Interpolator sInterpolator = new C00912();
    ...
    private final Runnable mEndScrollRunnable = new C00923();
    ...
    static class C00901 implements Comparator<ItemInfo> {
        C00901() {
        }
    ...
    static class C00912 implements Interpolator {
        C00912() {
        }
