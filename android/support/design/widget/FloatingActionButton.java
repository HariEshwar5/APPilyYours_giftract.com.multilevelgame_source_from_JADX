...
public class FloatingActionButton extends ImageView {
    ...
    class C02011 implements ShadowViewDelegate {
        C02011() {
        }
    ...
    public static class Behavior extends android.support.design.widget.CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        public void onDependentViewRemoved(CoordinatorLayout parent, FloatingActionButton child, View dependency) {
            if ((dependency instanceof SnackbarLayout) && ViewCompat.getTranslationY(child) != 0.0f) {
                ViewCompat.animate(child).translationY(0.0f).scaleX(1.0f).scaleY(1.0f).alpha(1.0f).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setListener(null);
            }
        }
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        ShadowViewDelegate delegate = new C02011();
