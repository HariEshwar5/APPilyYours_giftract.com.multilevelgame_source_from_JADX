...
public class TabLayout extends HorizontalScrollView {
    ...
    class C02082 implements AnimatorUpdateListener {
        C02082() {
        }
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mTabMinWidth = a.getDimensionPixelSize(C0000R.styleable.TabLayout_tabMinWidth, 0);
        this.mRequestedTabMaxWidth = a.getDimensionPixelSize(C0000R.styleable.TabLayout_tabMaxWidth, 0);
    ...
    private TabView createTabView(Tab tab) {
        ...
        if (this.mTabClickListener == null) {
            this.mTabClickListener = new C00131();
        }
        ...
        if (newPosition != -1) {
            ...
            if (startScrollX != targetScrollX) {
                if (this.mScrollAnimator == null) {
                    ...
                    this.mScrollAnimator.setUpdateListener(new C02082());
                }
    ...
    private ColorStateList loadTextColorFromTextAppearance(int textAppearanceResId) {
        TypedArray a = getContext().obtainStyledAttributes(textAppearanceResId, C0000R.styleable.TextAppearance);
        try {
            ColorStateList colorStateList = a.getColorStateList(C0000R.styleable.TextAppearance_android_textColor);
