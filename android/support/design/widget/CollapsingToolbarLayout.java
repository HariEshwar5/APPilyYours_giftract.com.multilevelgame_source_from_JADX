...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C01991 implements OnApplyWindowInsetsListener {
        C01991() {
        }
    ...
    class C02002 implements AnimatorUpdateListener {
        C02002() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C01991());
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.setUpdateListener(new C02002());
