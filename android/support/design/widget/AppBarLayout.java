...
public class AppBarLayout extends LinearLayout {
    ...
    class C01971 implements OnApplyWindowInsetsListener {
        C01971() {
        }
    ...
    public static class Behavior extends ViewOffsetBehavior<AppBarLayout> {
        ...
        final int setAppBarTopBottomOffset(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int newOffset) {
            return setAppBarTopBottomOffset(coordinatorLayout, appBarLayout, newOffset, Integer.MIN_VALUE, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
        }
        ...
        public boolean onMeasureChild(CoordinatorLayout parent, View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
            ...
            if (childLpHeight == -1 || childLpHeight == -2) {
                ...
                if (appBar != null && ViewCompat.isLaidOut(appBar)) {
                    ...
                    parent.onMeasureChild(child, parentWidthMeasureSpec, widthUsed, MeasureSpec.makeMeasureSpec((availableHeight - appBar.getMeasuredHeight()) + appBar.getTotalScrollRange(), childLpHeight == -1 ? 1073741824 : Integer.MIN_VALUE), heightUsed);
                    return true;
                }
            }
            return false;
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C01971());
    }
