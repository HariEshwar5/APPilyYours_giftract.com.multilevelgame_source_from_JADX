...
class AlertController {
    ...
    private final OnClickListener mButtonHandler = new C01291();
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0140R.attr.alertDialogCenterButtons, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0140R.styleable.AlertDialog, C0140R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0140R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0140R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0140R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0140R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0140R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0140R.styleable.AlertDialog_listItemLayout, 0);
        a.recycle();
    }
    ...
    private void setupView() {
        View customView;
        setupContent((ViewGroup) this.mWindow.findViewById(C0140R.id.contentPanel));
        boolean hasButtons = setupButtons();
        ViewGroup topPanel = (ViewGroup) this.mWindow.findViewById(C0140R.id.topPanel);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.mContext, null, C0140R.styleable.AlertDialog, C0140R.attr.alertDialogStyle, 0);
        boolean hasTitle = setupTitle(topPanel);
        View buttonPanel = this.mWindow.findViewById(C0140R.id.buttonPanel);
        if (!hasButtons) {
            buttonPanel.setVisibility(8);
            View spacer = this.mWindow.findViewById(C0140R.id.textSpacerNoButtons);
            if (spacer != null) {
                spacer.setVisibility(0);
            }
        }
        FrameLayout customPanel = (FrameLayout) this.mWindow.findViewById(C0140R.id.customPanel);
        if (this.mView != null) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0140R.id.custom);
    ...
    private boolean setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0140R.id.title_template).setVisibility(8);
            return true;
        }
        ...
        if (hasTextTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0140R.id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (ScrollView) this.mWindow.findViewById(C0140R.id.scrollView);
