...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02591();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02602();
    private boolean mShowingForMode;
    private ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    private TintManager mTintManager;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02413();

    class C02413 implements ViewPropertyAnimatorUpdateListener {
        C02413() {
        }
    ...
    class C02591 extends ViewPropertyAnimatorListenerAdapter {
        C02591() {
        }
    ...
    class C02602 extends ViewPropertyAnimatorListenerAdapter {
        C02602() {
        }
