...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C02621 extends ViewPropertyAnimatorListenerAdapter {
        C02621() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C02621();
        this.mRemoveActionBarHideOffset = new C01442();
        this.mAddActionBarHideOffset = new C01453();
        init(context);
