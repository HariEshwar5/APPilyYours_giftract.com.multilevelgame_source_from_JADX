...
public class Toolbar extends ViewGroup {
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C01741();
        int expandedMenuItemId;
        boolean isOverflowOpen;

        static class C01741 implements Creator<SavedState> {
            C01741() {
            }
    ...
    class C02481 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C02481() {
        }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C02481();
        this.mShowOverflowMenuRunnable = new C01722();
    ...
    private void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            ...
            this.mCollapseButtonView.setOnClickListener(new C01733());
        }
    }
